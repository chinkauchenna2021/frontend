...
import ColumnItems from './subcomp/ColumnItems';
function Header() {
...
<div className="lg:flex lg:items-center lg:justify-between align-middle flex-column justify-center sm:flex">
  ...
  <svg  className=" h-6 w-6 absolute top-3  text-gray-400  left-2 lg:left-4 lg:top-3  h-6 w-6" xmlns="http://www.w3.org/2000/svg"  fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
...
<div className="flex justify-center flex-column px-4 lg:mb-20  " style={{background:'rgba(13, 13, 13, 0.5)',flexDirection:'column',height:redsize}} >
      <div className="grid grid-cols-2 w-full py-4"  onClick={()=>accordion()}>
         <div className="flex justify-start align-middle">
            ...
            <span className="text-md text-white text-bg px-2 font-Manrope text-bold">Lorem ipsum</span>
         </div>
...
<div className="flex justify-between py-4"  onClick={()=>accordion2()}>
  ...
  <div className=" overflow-auto  lg:scrollbar-thin scrollbar-thumb-black scrollbar-track-gray-900  lg:pr-5" style={{height:second}}>
      ...
      <div className=" grid grid-cols-3 grid-rows-auto gap-2 px-2"  >
      <ColumnItems title={"Accessories & Ears"} sub={"Lorem ipsum"} per={"9%"}/>
      <ColumnItems title={"Arms"} sub={"Lorem ipsum"} per={"15%"}/>
      <ColumnItems title={"Background"} sub={"Lorem ipsum"} per={"2%"}/>
      <ColumnItems title={"Eye"} sub={"Lorem ipsum"} per={"32%"}/>
      <ColumnItems title={"Glasses"} sub={"Lorem ipsum"} per={"3%"}/>
      <ColumnItems title={"Hair & Hats"} sub={"Lorem ipsum"} per={"2%"}/> 
      <ColumnItems title={"Head"} sub={"Lorem ipsum"} per={"92%"}/>
      <ColumnItems title={"Legs & Cloths"} sub={"Lorem ipsum"} per={"2%"}/>
      <ColumnItems title={"Mouth"} sub={"Lorem ipsum"} per={"46%"}/>
      <ColumnItems title={"Accessories & Ears"} sub={"Lorem ipsum"} per={"9%"}/>
      <ColumnItems title={"Accessories & Ears"} sub={"Lorem ipsum"} per={"9%"}/>
      <ColumnItems title={"Accessories & Ears"} sub={"Lorem ipsum"} per={"9%"}/>
      <ColumnItems title={"Accessories & Ears"} sub={"Lorem ipsum"} per={"9%"}/>
